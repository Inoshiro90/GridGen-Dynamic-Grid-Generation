// function generateGridAndSVG(dimension, firstTableData, xMax, yMax, lineData) {
...
function generateGridAndSVG(dimension, firstTableData, xMax, yMax, lineData) {
	...
	// Cell Size und Einheit
	const pointDistance = parseFloat(pointDistanceInput.value);
	const unit = unitDropdown.value;
	...
	const pixel = 1;
	const pointDistanceInPixels =
		pointDistance * (unit === 'mm' ? mmToPixels : unit === 'inch' ? inchToPixels : pixel);
